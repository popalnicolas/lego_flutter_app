...
class LikedLegoScreen extends StatefulWidget {
  const LikedLegoScreen({Key? key}) : super(key: key);

  @override
  _LikedLegoScreenState createState() => _LikedLegoScreenState();
}

class _LikedLegoScreenState extends State<LikedLegoScreen> {
  ...
  void initState() {
    ...
    _likedLegoService.getLikedLegos().then((value) {
      setState(() {
        _products = value;
      });
    });
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              image: DecorationImage(
                ...
                image: NetworkImage("https://m.media-amazon.com/images/I/81UDsQCKwzL._AC_SL1500_.jpg"),
                fit: BoxFit.fitWidth,
          ...
          Align(
              ...
              child: Padding(
                ...
                child: Text("Liked Legos", style: TextStyle(color: Colors.white, fontSize: 40, fontWeight: FontWeight.bold),),
              )
          ),
        ],
      ),
